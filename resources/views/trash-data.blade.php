...
<table class="table">
    ...
    <tbody>
        @if(empty($customers->all()))
            <tr>
                <td colspan="5" class="font-weight-bold text-monospace text-center text-danger">Data not found</td>
            </tr>    
        @else
            ...
            <tr>
                ...
                <td>{{ $data['dob'] }}</td>
                <td>
                    <a href="{{ route('force_delete',['id' => $data['id']]) }}" class="btn btn-danger">delete</a>
